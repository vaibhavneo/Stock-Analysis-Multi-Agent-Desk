...
# It starts the multiagent stock desk at http://127.0.0.1:5052
#
...
echo "==> Starting the Multiagent Stock Desk at http://127.0.0.1:5052 ..."
python3 -m stock_ai_tool.web_server --host 127.0.0.1 --port 5052
